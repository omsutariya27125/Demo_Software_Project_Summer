    ...
    <div className={`dashboard-root ${darkMode ? 'dark' : ''}`}>
      ...
      <aside className={`sidebar ${minimized ? 'minimized' : ''}`}>
        ...
        <nav className="sidebar-nav">
          <a className="nav-item"><i className="fas fa-th-large nav-icon"></i><span className={`nav-text ${minimized ? 'hidden' : ''}`}>Dashboard</span></a>
          <a className="nav-item active"><i className="fas fa-user nav-icon"></i><span className={`nav-text ${minimized ? 'hidden' : ''}`}>Profile</span></a>
          <a className="nav-item"><i className="fas fa-robot nav-icon"></i><span className={`nav-text ${minimized ? 'hidden' : ''}`}>AI Analyzer</span></a>
          <a className="nav-item"><i className="fas fa-clipboard-question nav-icon"></i><span className={`nav-text ${minimized ? 'hidden' : ''}`}>Test / Quiz</span></a>
          <a className="nav-item"><i className="fas fa-sliders-h nav-icon"></i><span className={`nav-text ${minimized ? 'hidden' : ''}`}>Personalize</span></a>
        </nav>
      </aside>
